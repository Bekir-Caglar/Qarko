...
val managerModule = module {
    // UserManager, CartManager ve FavoritesManager birer Kotlin 'object' (singleton) olduğu için
    // singleOf(::ClassName) şeklinde kullanılamazlar. Doğrudan objeyi geçmeliyiz:
    single { UserManager }
    single { CartManager }
